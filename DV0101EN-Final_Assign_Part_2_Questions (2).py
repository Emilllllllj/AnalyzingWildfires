...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec= data.groupby('Vehicle_Type')['Advertising_Expenditure'].mean().reset_index()
        R_chart3 = dcc.Graph(
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        une_rec= data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
                figure = px.bar(une_rec,
                x='unemployment_rate',
                y = 'Automobile_Sales',
...
# Plot 2 Total Monthly Automobile sales using line chart.
        yas2= data.groupby('Month')['Automobile_Sales'].mean().reset_index()
